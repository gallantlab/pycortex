var mriview = (function(module) {
    ...
    module.Surface = function(ctminfo) {
        ...
        this.ui = (new jsplot.Menu()).add({
            ...
            leftToggle: {action: this.toggleLeftVis.bind(this), key: 'L', modKeys: ['shiftKey'], hidden: true, help:'Toggle left side'},
            right: {action:[this, "setRightVis"]},
            rightToggle: {action: this.toggleRightVis.bind(this), key: 'R', modKeys: ['shiftKey'], hidden: true, help:'Toggle right side'},
