# -*- coding: utf-8 -*-
#
# pycortex documentation build configuration file, created by
...
def _copy_notebook_artifacts(app, exception):
    """Copy static viewer files generated by notebook execution into the
    build output so IFrame references resolve correctly."""
...
def setup(app):
    app.connect("build-finished", _copy_notebook_artifacts)
...
project = "pycortex"
copyright = "2012\u2013%d, Gallant Lab" % datetime.now().year
...
latex_documents = [
    ("index", "pycortex.tex", "pycortex Documentation", "James Gao", "manual"),
]
...
man_pages = [("index", "pycortex", "pycortex Documentation", ["James Gao"], 1)]
...
epub_title = "pycortex"
epub_author = "Gallant Lab"
epub_publisher = "Gallant Lab"
epub_copyright = "2012\u2013%d, Gallant Lab" % datetime.now().year
